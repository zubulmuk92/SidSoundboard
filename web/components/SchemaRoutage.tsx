...
/** La double sortie, présentée comme la suite logique du rendu pré-calculé :
 *  un seul fichier rendu, joué à l'identique sur les deux cartes son. */
export function SchemaRoutage() {
  return (
    <div id="routage" className="mt-20 scroll-mt-24 border-t border-gel/12 pt-14">
      <h3 className="mb-3 font-display text-[clamp(1.8rem,3.4vw,2.6rem)] leading-tight font-black uppercase">
        Le même rendu, sur deux sorties à la fois
      </h3>
      <p className="chapo mb-10">
        Votre casque reçoit un volume confortable, le câble virtuel envoie le son à Discord au niveau que
        vous voulez. Les deux flux restent synchronisés — ce que vous entendez est exactement ce que vos
        potes prennent en pleine face.
      </p>
      ...
      <div className="panneau reveal p-[clamp(16px,3vw,32px)]">
        ...
        <svg viewBox="0 0 790 260" role="img" aria-label={LEGENDE} className="hidden h-auto w-full md:block">
          ...
          <path className="rt-fil rt-fil-azur" d="M188 138h84c14 0 14 56 28 56h140" markerEnd="url(#fleche-azur)" />
      ...
      <p className="reveal mt-6 max-w-[70ch] border-l-2 border-gel/30 pl-4 font-mono text-xs leading-relaxed text-brume">
        VB-Cable s&apos;installe séparément — SidSoundboard ne l&apos;installe pas à votre place et ne touche
        pas à vos périphériques système.
      </p>
    </div>
  );
}
