...
TRANSLATIONS = {
    "fr": {
        ...
        "profile.new_prompt": "Nom du profil :",
        "profile.rename": "Renommer",
        "profile.delete": "Supprimer",
        "profile.delete_confirm": "Supprimer le profil « {name} » et ses {count} son(s) ?",
        "profile.cannot_delete_last": "Impossible de supprimer le dernier profil.",
        "profile.section": "Profils",
        "scene.empty": "Aucun son dans ce profil.\nAjoutez-en depuis la Bibliothèque.",
        ...
        "welcome.library_ok": "{count} son(s) dans le profil actif",
    ...
    "en": {
        ...
        "profile.new_prompt": "Profile name:",
        "profile.rename": "Rename",
        "profile.delete": "Delete",
        "profile.delete_confirm": "Delete profile “{name}” and its {count} sound(s)?",
        "profile.cannot_delete_last": "The last profile cannot be deleted.",
        "profile.section": "Profiles",
        "scene.empty": "No sound in this profile.\nAdd some from the Library.",
        ...
        "welcome.library_ok": "{count} sound(s) in the active profile",
