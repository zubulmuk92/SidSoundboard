...
TRANSLATIONS = {
    "fr": {
        ...
        "nav.pads": " Pads",
        "nav.help": " Aide",
        "scene.label": "Scène active",
        "scene.new": "+ Nouvelle scène",
        "scene.new_prompt": "Nom de la nouvelle scène :",
        "scene.rename": "Renommer",
        "scene.rename_prompt": "Nouveau nom de la scène :",
        "scene.delete": "Supprimer",
        "scene.delete_confirm": "Supprimer la scène « {name} » et ses {count} son(s) ?\nLes fichiers audio ne sont pas effacés.",
        "scene.cannot_delete_last": "Impossible de supprimer la dernière scène : il en faut toujours une.",
        "scene.section": "Scènes",
        "scene.hint": "Une scène regroupe des sons et leurs raccourcis. Basculez-en une pour changer tout votre soundboard d'un coup.",
        "pads.empty": "Aucun son dans cette scène.\nAjoutez-en depuis la Bibliothèque.",
        "welcome.title": "Bienvenue dans SidSoundboard",
        "welcome.intro": "Trois choses à vérifier pour envoyer vos sons à vos amis.",
        "welcome.cable_ok": "Câble virtuel détecté : {name}",
        "welcome.cable_missing": "Aucun câble virtuel détecté",
        "welcome.cable_help": "Sans câble virtuel, vos sons ne sortent que dans votre casque. Installez VB-Cable, puis relancez SidSoundboard.",
        "welcome.dual_ok": "Double sortie activée",
        "welcome.dual_off": "Double sortie désactivée",
        "welcome.dual_help": "Activez-la dans les Réglages et choisissez le câble comme sortie secondaire.",
        "welcome.library_ok": "{count} son(s) dans la scène active",
        "welcome.library_empty": "Bibliothèque vide",
        "welcome.library_help": "Importez un fichier audio ou collez une URL YouTube.",
        "welcome.open_settings": "Ouvrir les Réglages",
        "welcome.open_library": "Ouvrir la Bibliothèque",
        "welcome.cable_link": "https://vb-audio.com/Cable/",
        "library.filter_all": "Toutes",
        "card.hotkey_conflict": "Touche déjà utilisée par : {names}",
        "settings.master_volume": "Volume général :",
    ...
    "en": {
        ...
        "nav.pads": " Pads",
        "nav.help": " Help",
        "scene.label": "Active scene",
        "scene.new": "+ New scene",
        "scene.new_prompt": "Name of the new scene:",
        "scene.rename": "Rename",
        "scene.rename_prompt": "New name for the scene:",
        "scene.delete": "Delete",
        "scene.delete_confirm": "Delete scene “{name}” and its {count} sound(s)?\nThe audio files are not removed.",
        "scene.cannot_delete_last": "The last scene cannot be deleted: there must always be one.",
        "scene.section": "Scenes",
        "scene.hint": "A scene groups sounds and their hotkeys. Switch scene to swap your whole soundboard at once.",
        "pads.empty": "No sound in this scene.\nAdd some from the Library.",
        "welcome.title": "Welcome to SidSoundboard",
        "welcome.intro": "Three things to check before your friends can hear your sounds.",
        "welcome.cable_ok": "Virtual cable detected: {name}",
        "welcome.cable_missing": "No virtual cable detected",
        "welcome.cable_help": "Without a virtual cable your sounds only reach your own headphones. Install VB-Cable, then restart SidSoundboard.",
        "welcome.dual_ok": "Dual output enabled",
        "welcome.dual_off": "Dual output disabled",
        "welcome.dual_help": "Enable it in Settings and pick the cable as the secondary device.",
        "welcome.library_ok": "{count} sound(s) in the active scene",
        "welcome.library_empty": "Empty library",
        "welcome.library_help": "Import an audio file or paste a YouTube URL.",
        "welcome.open_settings": "Open Settings",
        "welcome.open_library": "Open the Library",
        "welcome.cable_link": "https://vb-audio.com/Cable/",
        "library.filter_all": "All",
        "card.hotkey_conflict": "Key already used by: {names}",
